...
\begin{tabularx}{\textwidth}{l|X}
	...
	/PF60/ & \\ \hline
\end{tabularx}
\captionof{table}{Übersicht der Produktfunktionen}
...
\begin{figure}[H]
	\subfigure[Guide Hauptbildschirm]{\includegraphics[width=0.4\textwidth]{Bilder/Guide.png}}
	\subfigure[Guide Themen-Ebene]{\includegraphics[width=0.4\textwidth]{Bilder/GuideThemenbereich.png}}
	\subfigure[Guide Informations-Ebene]{\includegraphics[width=0.4\textwidth]{Bilder/GuideThemenbereich.png}}
...
\begin{figure}[H]
	\subfigure[Achivements Hauptbildschirm]{\includegraphics[width=0.49\textwidth]{Bilder/AchivementsUebersicht}}
	\subfigure[Achivements]{\includegraphics[width=0.49\textwidth]{Bilder/AchivementsUebersichtAchivements.jpg}}
	\caption{Benutzeroberfläche Achivements}
	\label{img:achivements}
\end{figure}
