...
\begin{tabularx}{\textwidth}{l|X|l}
	\toprule
	\textbf{Testgruppe} & \textbf{Testfall} & \textbf{Status}\\ \midrule
 	...
 	& Edit Task from Milestone & Erfolgreich \\ \midrule
 	Achievement/Challenge Reducers & Check Challenge Achievement & Erfolgreich \\ 
	\bottomrule
\end{tabularx}
