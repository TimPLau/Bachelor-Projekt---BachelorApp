...
\par Die gewählten Kategorien ergeben sich aus dem gewählten Auswertungsverfahren der qualitativen Inhaltsanalyse nach Mayring\cite{Mayring2008} und basieren in diesem Kontext auf die gemäß des Verfahrens herausgearbeiteten Codings.\\\\
...
- Übersicht über die verschiedenen Sektionen der Applikation
...
\subsection{Hinweise und Tipps}
- Leitfaden der FH-Lübeck als Grundlage für Hinweise und Tipps - Guide
\subsection{Comunity-Hub}
- Tipps von anderen?
- Hier Freundschaftsanfragen?
- Andere Profile Aufrufen?
\subsection{Dashboard}
- Zusammenfassung von bestimmten App Funktionen?
- Als Brückenelement zwischen Funktionalität und Gamification
- Fortschrittsanzeige
- Weekly Tasks
- Anzeige anderer User?
\section{Beschreibung der Gamificationelemente}
...
- Man bekommt Punkte für jeden abgehakten Task?
- Je mehr Unteraufgaben, desto mehr Punkte für einen Meilenstein? - Also macht man mehr Unteraufgaben und kann somit besser planen - Quasi wie Erfahrungspunkte?
- Bonusbatch für mehr als 10 Unteraufgaben?
- Nur einen Meilenstein pro Woche
- Auf Basis agiler Softwareentwicklung. Arbeitspaketbildung.
- Upvotes bringen Comunitybatches?
- Was bringen Auszeichnungen? Es gibt keine direkte Belohnung? Keinen Einfluss auf Ende der Bachelorarbeit! Deswegen muss anderer Anreiz her! -> Soziale Interaktion
\subsection{Soziale Interaktion}
- Man sieht das andere Personen Punkte abhacken?
