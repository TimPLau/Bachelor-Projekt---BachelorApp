...
\item Punktesysteme, Badges, Trophäen
\item Ranglisten 
...
\end{itemize}
\subsection{Nutzergruppen nach Bartle}
...
\item \textbf{Der Socializer}
\par Die Gruppe der Socializer sind immer auf der Suche nach sozialer Interaktivität. Ohne diese, können sie der Welt wenig bis keine Motivation abgewinnen. Die Spielwelt in der sie sich bewegen, ist vor allem nur der Mittel zum Zweck der Kommunikation. Der größte Stolz der Socializer ist die Freundschaft und der Kontakt zu anderen Personen:
...
\par Des weiteren wird eine Online-Umfrage den Teil der Datenerhebung darstellen, der quantitative Ergebnisse erzielen soll und deren Aussage somit eine nicht durch die schriftlichen Befragungen abgebildete Menge darstellt.
...
\par Die gewählten Kategorien ergeben sich aus dem gewählten Auswertungsverfahren der qualitativen Inhaltsanalyse nach Mayring\citep{Mayring2015} und basieren in diesem Kontext auf die gemäß des Verfahrens herausgearbeiteten Codings.\\\\
...
\begin{tabularx}{\textwidth}{l|X|c}
	...
	\multirow{3}*{Motivation durch soziale Einbindung} & Positiv & 3 \\
	& Negativ & 12 \\
	& Neutral & 2 \\ \hline
...
\par Aufgrund der eindeutigen Reaktionen der eingebundenen Studierenden, wird die Entscheidung getroffen, den ersten Ansatz nicht weiter zu verfolgen, dafür aber den zweiten Ansatz auszubauen.

\par Wie in \citep{Sailer2016}[S. 32 - 34] beschrieben wird, besitzen Achievements verschiedene Eigenschaften, welche in Bezug auf bestimmte Zielstellungen, einer steuernden und in diesem Sinne auch fordernden Funktion dienen können.\\\\
...
\par In der folgenden Tabelle sind die Produktanforderungen in natürlicher Sprache vorzufinden. Diese wurden auf Basis einer Anforderungsschablone aus dem Lehrbuch der Softwaretechnik von Helmut Balzert verfasst\citep{Balzert2010}.\\
\begin{itemize}

\item Die Applikation soll die Studierende bei dem Zeitmanagement unterstützen
\begin{itemize}
\item Die Software muss dem Studierenden ermöglichen, Meilenteine und zugehörige 		Aufgaben anzulegen und zu verwalten
\item Die Software soll den Studierende auf bevorstehende Meilensteine und Aufgaben aufmerksam machen
\end{itemize}

\item Die Applikation muss den Studierenden hilfreiche Informationen zum schreiben von Bachelorarbeiten bereitstellen
\begin{itemize}
\item Die Software soll den Studierenden Informationen über die Rahmenbedingungen und Formalien der Bachelorarbeit an der Fachhochschule Lübeck bieten
\item Die Software soll den Studierenden Hinweise und Empfehlungen zu Aufbau und Struktur von Bachelorarbeiten bieten
\item Die Software soll den Studierenden Hinweise und Empfehlungen zu Durchführung von Bachelorarbeiten bieten
\end{itemize}

\item Die Applikation muss den Studierenden motivierende Gamificationinhalte bieten
\begin{itemize}
\item Die Software ...
\end{itemize}
...
\begin{figure}[H]
	\subfigure[Guide Hauptbildschirm]{\includegraphics[width=0.4\textwidth]{Bilder/Prototyp/Guide.png}}
	\subfigure[Guide Themen-Ebene]{\includegraphics[width=0.4\textwidth]{Bilder/Prototyp/GuideThemenbereich.png}}
	\subfigure[Guide Informations-Ebene]{\includegraphics[width=0.4\textwidth]{Bilder/Prototyp/GuideThemenbereichInformationen.png}}
...
\par Der bisher geleistete Gesamtfortschritt wird verdeutlicht, indem zu sehen ist, wie viele Meilensteine bisher abschlossen wurden, in Relation zu den Gesamtmeilenstein. Weiterhin wird der bisher geleistete Wochenfortschritt verdeutlicht, indem zu sehen ist, wie viele Aufgaben in der Phase bis zum nächsten Meilenstein erfüllt wurden, in Relation zu den vorher definierten gesamten Aufgaben für diese Woche.
\item \textbf{Anzeige der zu leistenden Herausforderungen}
