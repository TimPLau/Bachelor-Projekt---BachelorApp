...
\par \bigskip Im Vorfeld zur Entwicklung der Applikation wurde eine Online Umfrage durchgeführt (siehe Anhang \ref{anhang:onlineUmfrageStudierendeErgebnisse}), welche die Bedarfssituation unter den Studierenden nach Untersützung bei der Bearbeitung der Bachelorarbeit darstellen soll.

\par Bei Betrachtung der Umfrageergebnisse ist anzunehmen, dass es im Kontext von Bachelorarbeiten unter einem großen Teil der Studierenden oftmals zu Schwierigkeiten kommt, das erworbene Wissen und die erlernten Fähigkeiten zielgerichtet auf reale Probleme anzuwenden sowie deren Ergebnisse zusammenhängend zu dokumentieren. Die hierbei erzielten Ergebnisse befassen sich nicht ausschließlich mit Studierenden an der Fachhochschule Lübeck, sondern mit Studierenden im Allgemeinen.
