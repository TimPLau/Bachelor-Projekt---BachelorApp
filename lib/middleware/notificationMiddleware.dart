      ...
      (result) {
        if (store.state.achievedAchievements["Achieved"].isNotEmpty) {
          ...
          if (store.state.achievedAchievements["Achieved"].length > 1) {
            showNotification(
                "Sehr gut! Du hast ${store.state.achievedAchievements["Achieved"]
                    .length} Achievement erhalten",
                "");
          } else if (store.state.achievedAchievements["Achieved"].length == 1) {
            showNotification("Sehr gut! Du hast ein Achievement erhalten",
                store.state.achievedAchievements["Achieved"].values.toList()[0].title);
          }
